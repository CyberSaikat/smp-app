...
class TeacherInternalMarks extends StatefulWidget {
  const TeacherInternalMarks({super.key});

  @override
  State<TeacherInternalMarks> createState() => _TeacherInternalMarksState();
}

class _TeacherInternalMarksState extends State<TeacherInternalMarks> {
  final exams = [
    ['1st Internal', '1st'],
    ['2nd Internal', '2nd']
  ];
